...
public class VooDAO {
	...
	public void save(Voo voo) {
		...
		String sql = "INSERT INTO voo (Origem, Destino, Data_Ida, Data_Volta)" + " VALUES( ?, ?, ?, ?)";
	...
	public void update(Voo voo) {
		String sql = "UPDATE voo SET Origem = ?, Destino = ?, Data_Ida = ?, Data_Volta = ? WHERE Id_voo = ?;";
