...
public class ClienteDAO {
	...
	public void save(Cliente cliente) {
		...
		String sql = "INSERT INTO Cliente(Nome, Telefone, CPF, Estado, Cidade, Bairro, Rua, Numero, CEP)"
				+ " VALUES(?, ?, ?, ?, ?, ?, ?, ?,  ?)";
	...
	public void update(Cliente cliente) {
		String sql = "UPDATE cliente set Nome = ?, Telefone = ?, CPF = ?, Estado = ?, Cidade = ?, Bairro = ?, Rua = ?, Numero = ?, CEP = ?  where Id_cliente = ?;";
